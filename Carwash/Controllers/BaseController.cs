...
namespace AppWebWithSweetAlert.Controllers
{
    ...
    {
        public void Alert(string message, NotificationTypeMessage notificationTypeMessage, NotificationType notificationType)
        {
            var msg = "<script language='javascript'>Swal.fire('" + notificationTypeMessage + "', '" + message + "','" + notificationType + "')" + "</script>";
